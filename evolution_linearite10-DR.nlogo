...
Here is the support model for a research paper by Delattre & Baguette on the evolution of dispersal syndromes (Delattre, T. & Baguette, M. (in review) Coevolution of genetically unrelated traits and the emergence of dispersal syndromes ).
Please refer to the article "Methods" section for a thorough description of the sctructure and mechanisms of the model.


## CREDITS AND REFERENCES
This model has been designed and programmed by Thomas Delattre (thomas.delattre@avignon.inra.fr).
It is distributed under GPL Licence. Any use should credit Thomas Delattre and the original research paper (Delattre, T. & Baguette, M. (in review) Coevolution of genetically unrelated traits and the emergence of dispersal syndromes )
@#$#@#$#@
default
true
0
